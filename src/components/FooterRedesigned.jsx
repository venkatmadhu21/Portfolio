  ...
  const socialLinks = [
    {
      ...
      url: 'https://github.com/venkatmadhu21',
    ...
    },
    {
      ...
      url: 'https://www.linkedin.com/in/venkatmadhu',
    ...
    },
    {
      ...
      url: 'https://www.hackerrank.com/profile/venkatmadhu232',
      color: 'text-primary-400 hover:text-primary-300'
    },
    {
      name: 'Email',
      ...
      url: 'mailto:venkatmadhumohann@gmail.com',
      color: 'text-secondary-400 hover:text-secondary-300'
    }
  ];
            ...
            <div className="flex items-center mb-4">
              ...
              >
                ...
                <div className="relative w-full h-full rounded-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-primary-500/30 shadow-lg overflow-hidden">
                  ...
                  {/* Modern accent ring */}
                  <div className="absolute inset-1 rounded-full border border-primary-400/20" />
                </div>
              </motion.div>
